...
public class HttpHandler extends Thread {
	...
	public static String BASE_URL = "http://192.168.1.100:8080/NextMove-war";//"http://10.76.72.16:8080/NextMove-war";
	...
	public void accrejMoveDealRequest(){
		...
		try {
			...
			acceptRejectReqObject.put(HttpConstants.USERID_JKEY, "38bdceac-1289-4b2c-95b7-9e7572c4dc6c");
			acceptRejectReqObject.put(HttpConstants.MOVEID_JKEY, "9e84dac5-0338-4769-a1ce-0e2ad0e67774");
			acceptRejectReqObject.put(HttpConstants.MOVES_STATUS_KEY, "REJECTED");
			requestBody = new JSONObject().put(HttpConstants.GETMYMOVES_REQUEST_KEY, acceptRejectReqObject).toString();
		} catch (JSONException e) {
			e.printStackTrace();
		}
	...
	public void doSignUp(Context context,HTTPResponseListener mHttpResponseListener){
		...
		try {
			...
			signUpReqObject.put(HttpConstants.EMAILADDRESS_JKEY, "anaschaky@yahoo.co.in");
			signUpReqObject.put(HttpConstants.PASSWORD_JKEY, "12345678");
			signUpReqObject.put(HttpConstants.ADDRESS_JKEY, "Bangalore  gmail.com");
			signUpReqObject.put(HttpConstants.PHONENUMBER_JKEY, "7406667752");
			
			signUpReqObject.put(HttpConstants.NAME_JKEY, "Anas Abubacker");
			
			
		
			requestBody = new JSONObject().put(HttpConstants.SIGNUP_REQUEST, signUpReqObject).toString();
		} catch (JSONException e) {
			e.printStackTrace();
		}
		this.context = context;
	...
	public void doUpdateProfile(Context context,HTTPResponseListener mHttpResponseListener){
		...
		try {
			...
			updateProfileReqObject.put(HttpConstants.USERID_JKEY, "38bdceac-1289-4b2c-95b7-9e7572c4dc6c");
			updateProfileReqObject.put(HttpConstants.PHONENUMBER_JKEY, "7406667752");
			updateProfileReqObject.put(HttpConstants.NAME_JKEY, "John Carey Updated ");
			updateProfileReqObject.put(HttpConstants.ADDRESS_JKEY, "Bangalore ");
			
			
			
		
			requestBody = new JSONObject().put(HttpConstants.UPDATE_PROFILE_REQUEST, updateProfileReqObject).toString();
		} catch (JSONException e) {
			e.printStackTrace();
		}
		this.context = context;
	...
	public void createMove(Context context,
		...
		try {
			...
			createMoveReqObject.put(HttpConstants.EXPECTED_RECEIVEDDATE_JKEY, "21/02/2014");
			createMoveReqObject.put(HttpConstants.DESTINATION_ADDESS_JKEY, "Bangalore pincode 560100");
			createMoveReqObject.put(HttpConstants.DISPATCH_DATE_JKEY, "19/02/2014");
			createMoveReqObject.put(HttpConstants.USERID_JKEY, "38bdceac-1289-4b2c-95b7-9e7572c4dc6c");
			...
			requestBody = new JSONObject().put(HttpConstants.MOVE_REQUEST_JKEY, createMoveReqObject).toString();
